...
<body style="opacity: 0; transition: 0.2s;" onload="init()" class="is-flex is-justify-content-space-between is-flex-direction-column">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse is-flex is-flex-direction-row justify-content-between align-items-center"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="#">Отслеживание</a></li>
                <li class="nav-item"><a class="nav-link" href="#contacts">Контакты</a></li>
            </ul>
            <ul class="pagination mt-3">
                <li class="page-item disabled">
                    <button id="cart_counter" class="page-link btn-primary" href="">0</button>
                </li>
                <li class="page-item"><a class="page-link btn-success text-success" style="cursor: pointer"
                                         data-bs-toggle="modal" data-bs-target="#cartModal">Корзина</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="order_form">
                    ...
                    <p class="form-text">Телефон необходим для связи представителя магазина при подтверждении заказа, и курьера (Формат: 79234567890)</p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#orderResultModal">
                    Оформить заказ
                </button>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="padding: 20px" id="result-body">
                    ...
                    <p class="fst-italic fw-light">Номер вашего заказа: 34</p>
    ...
    <div class="row d-flex justify-content-center align-items-start">
        <div class="col text-center">
            ...
            <a href="mailto:hq@maskarada.ru" style="font-size: 32px; color: #323232"
               class="fw-light">hq@maskarada.ru</a>
        </div>
        <div class="col text-center">
